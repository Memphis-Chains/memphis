...
- `npx vitest run tests/unit/readiness.test.ts tests/unit/tool-surface-audit.test.ts tests/unit/tool-schema-audit.test.ts tests/unit/self-governance.test.ts tests/unit/tensor-status.test.ts tests/unit/public-chat-contract.test.ts tests/mcp/server.test.ts tests/unit/in-process-tool-executor.test.ts tests/mcp/soul-tools.test.ts tests/unit/rust-bridge-manifest.test.ts tests/unit/rust-embed-adapter.test.ts tests/backup.test.ts tests/unit/nightly-training-job-runner.test.ts tests/unit/nightly-training-worker.test.ts tests/unit/nightly-install-runner.test.ts`
