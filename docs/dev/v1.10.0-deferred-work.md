...
### Deferred nightly training implementation

The disconnected Kartograf nightly-training proposer, worker, and install-runner
sources were removed on 2026-07-10. They had no bootstrap owner, no complete
install consumer, and could not be activated by their advertised environment
flags. The design remains in `notes/v2-nightly-modules-sketch.md`; rebuild it
only with a concrete GPU-backed operator workflow, explicit approval, rollback,
