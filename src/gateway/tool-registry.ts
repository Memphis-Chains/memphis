...
export const TOOL_REGISTRY: Record<string, ToolMeta> = {
  ...
  memphis_lr_dashboard: {
    ...
    cliFlags: [
      {
        name: '--action',
        description: 'status or add_entry.',
        takesValue: true,
      },
      {
        name: '--measured-at',
        description: 'Measurement timestamp/date, e.g. 2026-07-07.',
        takesValue: true,
      },
      {
        name: '--category',
        description: 'Dashboard category, e.g. body-ph.',
        takesValue: true,
      },
      {
        name: '--marker',
        description: 'Measurement marker, e.g. urine_ph.',
        takesValue: true,
      },
      {
        name: '--value',
