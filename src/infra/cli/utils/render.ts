...
function generateBashCompletionScript(): string {
  return [
    ...
    '      setup) COMPREPLY=( $(compgen -W "status matrix" -- "${cur}") ); return 0 ;;',
    ...
    '    setup)',
    '      if [[ "${sub}" == "matrix" ]]; then flag_candidates="--server-name --admin-user --admin-pass --json";',
...
function generateFishCompletionScript(): string {
  return [
    ...
    '  complete -c $c -f -n "__fish_seen_subcommand_from setup" -a "status matrix"',
    ...
    '  complete -c $c -n "__fish_seen_subcommand_from setup matrix" -l server-name',
    '  complete -c $c -n "__fish_seen_subcommand_from setup matrix" -l admin-user',
    '  complete -c $c -n "__fish_seen_subcommand_from setup matrix" -l admin-pass',
