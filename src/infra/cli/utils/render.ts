...
function generateBashCompletionScript(): string {
  return [
    ...
    '    COMPREPLY=( $(compgen -W "setup init workspace context apps health reflect learn insight insights connections suggest knowledge serve service reset repair providers:health providers models chat ask categorize decide infer agents relationships trust mcp debug tui doctor chain sync trade soul vault embed ascii progress celebrate guide completion help" -- "${cur}") )',
    '    return 0',
    '  fi',
    '',
...
function generateFishCompletionScript(): string {
  return [
    ...
    'for c in memphis',
    '  complete -c $c -f -n "__fish_use_subcommand" -a "setup init workspace context apps health reflect learn insight insights connections suggest knowledge serve service reset repair providers:health providers models chat ask categorize decide infer agents relationships trust mcp debug tui doctor chain sync trade soul vault embed guide completion help"',
    ...
    '  complete -c $c -n "__fish_seen_subcommand_from reset" -l runtime',
