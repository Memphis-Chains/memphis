...
function generateBashCompletionScript(): string {
  return [
    ...
    '    case "${cmd}" in',
    '      providers) COMPREPLY=( $(compgen -W "list health" -- "${cur}") ); return 0 ;;',
    ...
    '      soul) COMPREPLY=( $(compgen -W "show manifest memory replay step seed" -- "${cur}") ); return 0 ;;',
    ...
    '      elif [[ "${sub}" == "step" ]]; then flag_candidates="--state --action --limits --json";',
    '      elif [[ "${sub}" == "seed" ]]; then flag_candidates="--json"; fi',
    '      ;;',
    '    vault)',
...
function generateFishCompletionScript(): string {
  return [
    ...
    '  complete -c $c -f -n "__fish_seen_subcommand_from providers" -a "list health"',
    ...
    '  complete -c $c -f -n "__fish_seen_subcommand_from soul" -a "show manifest memory replay step seed"',
